                    ...
                    switch (p.Type)
                    {
                        ...
                        case PropertyType.Bool:
                            if (p.PropertyValue.LongValue == 0)
                                ss += String.Format(" True :\n");
                            else
                                ss += String.Format(" False :\n");
                            break;
                        ...
                        case PropertyType.Enum:
                            ...
                            if (p.Id == ModelCode.REGULATINGCONTROL_MONITOREDPHASE)
                            {
                                ss += String.Format("{0}\n", (PhaseCode)p.PropertyValue.LongValue);
                            }
                            if (p.Id == ModelCode.BASICINTERVALSCHEDULE_VALUE1UNIT)
                            {
                                ss += String.Format("{0}\n", (UnitSymbol)p.PropertyValue.LongValue);
                            }
                            if (p.Id == ModelCode.BASICINTERVALSCHEDULE_VALUE2UNIT)
                            {
                                ss += String.Format("{0}\n", (UnitSymbol)p.PropertyValue.LongValue);
                            }
                            if (p.Id == ModelCode.BASICINTERVALSCHEDULE_VALUE1MULTIPLIER)
                            {
                                ss += String.Format("{0}\n", (UnitMultiplier)p.PropertyValue.LongValue);
                            }
                            if (p.Id == ModelCode.BASICINTERVALSCHEDULE_VALUE2MULTIPLIER)
                            {
                                ss += String.Format("{0}\n", (UnitMultiplier)p.PropertyValue.LongValue);
                            }
                            break;
